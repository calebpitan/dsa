 ...
 * @template K, V
 * @param {MinHeapQueue<K, V>} heap The heap structure to insert into
 ...
 * @template K, V
 * @param {MinHeapQueue<K, V>} heap The heap structure
 ...
 * @template K, V
 * @param {MinHeapQueue<K, V>} heap The heap data structure
 * @returns {Tuple<K, V>}
 */
