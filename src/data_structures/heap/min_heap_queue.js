...
/**
 * @template K, V
 * @typedef {Tuple<K, V>[]} MinHeapQueue<K, V>
 */
 ...
 * @template V
 * @param {MinHeapQueue<number, V>} heap The heap structure to insert into
 ...
 * @template V
 * @param {MinHeapQueue<number, V>} heap The heap structure
 ...
 * @template V
 * @param {MinHeapQueue<number, V>} heap The heap data structure
 * @returns {Tuple<number, V>}
 */
...
export { extract_min, heapify, height, insert, min, remove, siftdown, size };
